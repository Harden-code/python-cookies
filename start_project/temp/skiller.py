...
interpreter.llm.api_key = os.getenv('OPENAI_URL')
interpreter.llm.api_base = 'https://api.chatanywhere.tech/v1'
interpreter.auto_run = True

interpreter.messages = []
interpreter.chat('帮我打开浏览器,输入网站:www.baidu.com')
# interpreter.chat('')
'''

[
{'role': 'system', 'type': 'message', 'content': 'You are Open Interpreter, a world-class programmer that can complete
...
** to execute any code necessary to complete the task. Execute the code.
...
for *stateful* languages (like python, javascript, shell, but NOT for html which starts from 0 every time) 
...
# Google search results will be returned from this function as a string
...
User InfoName: harden
CWD: /Users/harden/python/start_project/temp
SHELL: /bin/zsh
OS: Darwin'}
,{'role': 'user', 'type': 'message', 'content': 'Can you solve this equation? 10x + 14 = 21 / 3'}]
'''
